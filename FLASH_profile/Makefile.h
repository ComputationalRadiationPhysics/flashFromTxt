...
MPI_PATH   = /trinity/shared/pkg/mpi/openmpi/2.1.2/gcc/7.3.0/bin
HDF4_PATH  =
HDF5_PATH  = /trinity/shared/pkg/filelib/hdf5-parallel/1.8.20/gcc/7.3.0/openmpi/2.1.2
#HYPRE_PATH = /trinity/shared/pkg/analysis/hypre/2.11.2
HYPRE_PATH = /trinity/shared/pkg/analysis/hypre/2.10.0b
LAPACK_PATH = /trinity/shared/pkg/numlib/lapack/3.9.0/gcc/7.3.0
...
#FCOMP   = ${MPI_PATH}/mpif90 -fpic -rdynamic -mcmodel=medium 
#CCOMP   = ${MPI_PATH}/mpicc
#CPPCOMP = ${MPI_PATH}/mpicxx
#LINK    = ${MPI_PATH}/mpif90 -fpic -rdynamic -mcmodel=medium
...
-fimplicit-none -fstack-protector-all -ldl

FFLAGS_TEST = -ggdb -c -O0 -fdefault-real-8 -fdefault-double-8 -ldl
...
FFLAGS_OPT   = -I${HDF5_PATH}/include -ggdb -c -O2 -fdefault-real-8 -fdefault-double-8 -Wuninitialized -ldl
FFLAGS_DEBUG = -I${HDF5_PATH}/include -ggdb -c -O0 -fdefault-real-8 -fdefault-double-8 -pedantic -Wall -Waliasing -Wsurprising -Wconversion -Wunderflow -ffpe-trap=invalid,zero,overflow -fbounds-check -fimplicit-none -fstack-protector-all -ldl
FFLAGS_TEST  = -I${HDF5_PATH}/include -ggdb -c -O0 -fdefault-real-8 -fdefault-double-8 -ldl
...
LIB_HDF4  =
LIB_HDF5  = -L${HDF5_PATH}/lib -lhdf5_fortran -lhdf5 -lz -ldl
...
LIB_HYPRE = -L${HYPRE_PATH}/lib -lHYPRE -lstdc++
