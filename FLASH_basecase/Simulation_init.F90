...
#include "Flash.h"
  ...
  call RuntimeParameters_get('sim_heatDepth', sim_heatDepth)
  call RuntimeParameters_get('sim_heatRadius', sim_heatRadius)
  call RuntimeParameters_get('sim_heatTemp', sim_heatTemp)

  call RuntimeParameters_get('smallX', sim_smallX)

  call RuntimeParameters_get('sim_initGeom', sim_initGeom)

  call RuntimeParameters_get('sim_inputFilenameRoot', sim_inputFilenameRoot)
